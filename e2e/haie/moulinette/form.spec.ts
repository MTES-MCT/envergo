...
test('A petitioner can submit a project', async ({ page }) => {
  ...
  await page.locator('#hedge-input-iframe').contentFrame().getByRole('dialog', { name: 'Description de la haie D1' }).getByLabel('Type de haie').selectOption('alignement');
  ...
  await page.locator('#hedge-input-iframe').contentFrame().getByRole('dialog', { name: 'Description de la haie D2' }).getByLabel('Type de haie').selectOption('mixte');
  ...
  await page.locator('#hedge-input-iframe').contentFrame().getByRole('dialog', { name: 'Description de la haie P1' }).getByLabel('Type de haie').selectOption('alignement');
  ...
  await page.locator('#hedge-input-iframe').contentFrame().getByRole('dialog', { name: 'Description de la haie P2' }).getByLabel('Type de haie').selectOption('mixte');
