...
def test_ep_normandie_dispense_20m(ep_normandie_criterion, zonage_normandie):  # noqa
    ...
    moulinette = MoulinetteHaie(data)
    assert moulinette.is_valid(), moulinette.form_errors()
    assert moulinette.ep.hru__ep_normandie.result_code == "dispense_20m"
...
def test_ep_normandie_interdit_20m(ep_normandie_criterion, zonage_normandie):  # noqa
    ...
    moulinette = MoulinetteHaie(data)
    assert moulinette.is_valid(), moulinette.form_errors()
    assert moulinette.ep.hru__ep_normandie.result_code == "interdit"
...
def test_ep_normandie_dispense_coupe_a_blanc(
    ...
    moulinette = MoulinetteHaie(data)
    assert moulinette.is_valid(), moulinette.form_errors()
    assert moulinette.ep.hru__ep_normandie.result_code == "dispense_coupe_a_blanc"
...
def test_ep_normandie_interdit_remplacement(
    ...
    assert moulinette.ep.hru__ep_normandie.result_code == "derogation_simplifiee"
...
def test_ep_normandie_dispense(ep_normandie_criterion):  # noqa
    ...
    moulinette = MoulinetteHaie(data)
    assert moulinette.is_valid(), moulinette.form_errors()
    assert moulinette.ep.hru__ep_normandie.result_code == "dispense"
...
def test_ep_normandie_l350(motif_result, ep_normandie_criterion, france_map):  # noqa
    ...
    moulinette = MoulinetteHaie(data)
    assert moulinette.is_valid(), moulinette.form_errors()
    assert moulinette.ep.hru__ep_normandie.result_code == result_code
