...
def test_3310_small_footprint_outside_wetlands():
    ...
    moulinette = MoulinetteAmenagement(make_amenagement_data(created_surface=50, final_surface=50))
...
def test_3310_medium_footprint_inside_wetlands():
    ...
    moulinette = MoulinetteAmenagement(make_amenagement_data(created_surface=700, final_surface=700))
    moulinette.catalog["wetlands_within_25m"] = True
    moulinette.evaluate()
...
def test_3310_medium_footprint_inside_wetlands_2():
    """Project with 700 <= footprint <= 1000m² within a wetland."""
    moulinette = MoulinetteAmenagement(make_amenagement_data(created_surface=800, final_surface=800))
    moulinette.catalog["wetlands_within_25m"] = True
    moulinette.evaluate()
    assert moulinette.loi_sur_leau.zone_humide.result == "action_requise"
...
def test_3310_large_footprint_within_wetlands():
    ...
    moulinette = MoulinetteAmenagement(make_amenagement_data(created_surface=1500, final_surface=1500))
    moulinette.catalog["wetlands_within_25m"] = True
    moulinette.evaluate()
...
def test_3220_small_footprint():
    ...
    moulinette = MoulinetteAmenagement(make_amenagement_data(created_surface=299, final_surface=299))
...
def test_3220_medium_footprint_within_flood_zones():
    ...
    moulinette = MoulinetteAmenagement(make_amenagement_data(created_surface=300, final_surface=300))
    moulinette.catalog["flood_zones_within_12m"] = True
    moulinette.evaluate()
...
def test_3220_small_footprint_outside_flood_zones():
    ...
    moulinette = MoulinetteAmenagement(make_amenagement_data(created_surface=200, final_surface=200))
    moulinette.evaluate()
    assert moulinette.loi_sur_leau.zone_inondable.result == "non_concerne"
...
def test_3220_large_footprint_within_flood_zones():
    ...
    moulinette = MoulinetteAmenagement(make_amenagement_data(created_surface=400, final_surface=400))
    moulinette.catalog["flood_zones_within_12m"] = True
    moulinette.evaluate()
...
def test_2150_not_so_big():
    moulinette = MoulinetteAmenagement(make_amenagement_data(created_surface=9000, final_surface=9000))
    moulinette.evaluate()
    assert moulinette.loi_sur_leau.ecoulement_sans_bv.result_code == "action_requise"


def test_2150_big():
    moulinette = MoulinetteAmenagement(make_amenagement_data(created_surface=10000, final_surface=10000))
    moulinette.evaluate()
    assert moulinette.loi_sur_leau.ecoulement_sans_bv.result_code == "soumis_ou_pac"


def test_2150_medium():
    moulinette = MoulinetteAmenagement(make_amenagement_data(created_surface=8000, final_surface=8000))
    moulinette.evaluate()
    assert moulinette.loi_sur_leau.ecoulement_sans_bv.result_code == "action_requise"


def test_2150_small():
    moulinette = MoulinetteAmenagement(make_amenagement_data(created_surface=7000, final_surface=7000))
    moulinette.evaluate()
...
def test_2150_with_pv_sol_big():
    ...
    moulinette.evaluate()
    assert moulinette.loi_sur_leau.ecoulement_sans_bv.result_code == "action_requise_pv_sol"
...
def test_2150_avec_bv_small_but_big_bv(mock_get_catchment_area):
    ...
    moulinette = MoulinetteAmenagement(make_amenagement_data(created_surface=1400, final_surface=1400))
    moulinette.evaluate()
    assert moulinette.loi_sur_leau.ecoulement_avec_bv.result_code == "non_soumis"
...
def test_2150_avec_bv_medium_but_big_bv(mock_get_catchment_area):
    mock_get_catchment_area.return_value = 12000
    moulinette = MoulinetteAmenagement(make_amenagement_data(created_surface=1600, final_surface=1600))
    moulinette.evaluate()
    assert moulinette.loi_sur_leau.ecoulement_avec_bv.result_code == "action_requise"
...
def test_2150_avec_bv_with_pv_sol_big():
    ...
    moulinette = MoulinetteAmenagement(data)
    moulinette.evaluate()
    assert moulinette.loi_sur_leau.ecoulement_avec_bv.result_code == "action_requise_pv_sol"
