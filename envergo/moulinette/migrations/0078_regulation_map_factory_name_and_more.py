# Generated by Django 4.2.19 on 2025-04-10 07:19

from django.db import migrations, models

def update_map_factory_name(apps, schema_editor):
    Regulation = apps.get_model("moulinette", "Regulation")
    regulations = Regulation.objects.filter(show_map=True).all()
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(update_map_factory_name, migrations.RunPython.noop),
