# Generated by Django 4.2.23 on 2025-11-21 09:21
...
def init_single_procedure_settings(apps, schema_editor):
    ConfigHaie = apps.get_model("moulinette", "ConfigHaie")
    ConfigHaie.objects.filter(single_procedure=True).update(single_procedure_settings={
        "coeff_compensation":
            {
                "degradee": 1.0,
                "buissonnante": 1.0,
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(init_single_procedure_settings, migrations.RunPython.noop),
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                ...
                violation_error_message="Les paramètres de régime unique doivent comporter des coefficients de compensation numérique pour chaque type de haies (degradee, buissonnante, arbustive et mixte).",
            ),
        ),
    ]
