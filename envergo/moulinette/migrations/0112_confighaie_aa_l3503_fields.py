# Generated by Django 4.2.28 on 2026-04-16 14:45

from django.db import migrations, models


def populate_aa_l3503_contact_info(apps, schema_editor):
    """Set a placeholder for aa_l3503_contact_info on single-procedure departments.

    Only departments with single_procedure=True need a non-empty contact_info
    when the default handling mode is "not_handled".
    """
    ConfigHaie = apps.get_model("moulinette", "ConfigHaie")
    ConfigHaie.objects.filter(single_procedure=True).update(
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name="aa_l3503_contact_info",
            field=models.TextField(
                blank=True, verbose_name="Informations de contact AA L350-3"
            ),
        ),
        migrations.AddField(
            model_name="confighaie",
            name="aa_l3503_form_url",
            field=models.URLField(blank=True, verbose_name="URL formulaire AA L350-3"),
        ),
        migrations.AddField(
            model_name="confighaie",
            name="aa_l3503_handling",
            field=models.CharField(
                choices=[
                    ("portal", "Dépôt sur le portail"),
                    ("third_party_form", "Dépôt sur un formulaire tiers"),
                    ("not_handled", "Pas de prise en compte (contacter le service)"),
                ],
                default="not_handled",
                max_length=32,
                verbose_name="Prise en compte des AA L350-3",
            ),
        ),
        ...
        migrations.RunPython(
            populate_aa_l3503_contact_info,
