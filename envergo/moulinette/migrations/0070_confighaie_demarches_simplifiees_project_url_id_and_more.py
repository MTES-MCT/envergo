# Generated by Django 4.2.17 on 2025-02-14 09:40

from django.db import migrations, models

def set_default_project_url_id(apps, schema_editor):
    ConfigHaie = apps.get_model('moulinette', 'ConfigHaie')
    for config in ConfigHaie.objects.filter(demarche_simplifiee_number__isnull=False):
        if not config.demarches_simplifiees_project_url_id:
            config.demarches_simplifiees_project_url_id = 'Q2hhbXAtNDU0Mzk0Mw=='
            config.save()

class Migration(migrations.Migration):

    dependencies = [
        ("moulinette", "0069_merge_20250124_1157"),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True,
                max_length=64,
                verbose_name='Identifiant du "Lien internet de la simulation réglementaire de votre projet" dans Démarches Simplifiées',
            ),
        ),
        migrations.RunPython(set_default_project_url_id, migrations.RunPython.noop),
