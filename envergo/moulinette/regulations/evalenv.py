...
TYPE_STATIONNEMENT_CHOICES = (
    ...
    ("mixed", "Mixte (au moins un emplacement ouvert au public)", "Mixte public-privé (au moins un emplacement est ouvert au public)"),
    ("private", "Entièrement privé"),
)
...
TYPE_EQUIPEMENT_CHOICES = (
    ...
    ("autre", "Aucun de ces types", "Ni parc de loiris, ni équipement sportif ou culturel"),
)
