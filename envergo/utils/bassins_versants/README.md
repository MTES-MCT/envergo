...
dossier_de_destination/RGE_ALTI/1_DONNEES_LIVRAISON_\[...]
...
## Lancer des tests de benchmark de paramètres :
...
Ensuite, il suffit de lancer le fichier [parameters_benchmark.py](parameters_benchmark.py), par exemple avec `python3.11 parameters_benchmark.py`
