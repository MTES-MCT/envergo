...
def test_following_instructors_on_petition_project(
    haie_user_44, haie_instructor_44, admin_user
):
    ...
    petition_project.followed_by.add(haie_user_44)
    petition_project.followed_by.add(haie_instructor_44)
    ...
    assert following_instructors.first() == haie_instructor_44

    # GIVEN a petition project in 34 followed by users in 44
    project_34 = PetitionProject34Factory.create()
    project_34.followed_by.add(haie_user_44)
    project_34.followed_by.add(haie_instructor_44)
