...
class EvaluationEmail:
    ...
    def get_bcc_recipients(self):
        ...
        if evaluation.user_type == USER_TYPES.instructor:
            if evaluation.is_icpe or evaluation.send_eval_to_project_owner:
                if self.moulinette.sage and self.moulinette.sage.result in (
                    "interdit",
                    "soumis",
                    "action_requise",
                ):
                    if self.moulinette.sage.perimeter.contact_email:
                        bcc_recipients.append(self.moulinette.sage.contact_email)
                    else:
                        logger.warning(
