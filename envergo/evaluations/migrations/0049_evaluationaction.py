...
def seed_actions(apps, schema_editor):
    ...
    actions = [
        ("mention_arrete_lse", "action", "instructor", 1, "Mentionner dans l’arrêté le différé de réalisation des travaux", "Le projet est susceptible d’être soumis à la Loi sur l’eau. L’arrêté municipal doit faire référence au fait que les travaux ne peuvent pas commencer avant l'accord préfectoral (conformément au R*424-6 du code de l’urbanisme).", []),
        ("depot_pac_lse", "action", "petitioner", 1, "Déposer un porter-à-connaissance auprès de la DDT(M)", "… si le projet existant a déjà fait l’objet d’un dossier Loi sur l’eau.\n\nSi au contraire le projet n'a jamais fait l'objet d'un dossier Loi sur l’eau, il doit être remis en conformité : un dossier Loi sur l’eau portant sur l’ensemble du projet doit être déposé.", []),
        ("depot_dossier_lse", "action", "petitioner", 1, "Déposer un dossier Loi sur l'eau", "", []),
        ("etude_zh_lse", "action", "petitioner", 11, "Réaliser un inventaire zones humides", "Si le projet détruit ou affecte le fonctionnement de plus de 1 000 m² de zones humides, il est soumis à déclaration Loi sur l’eau.", []),
        ("etude_zi_lse", "action", "petitioner", 12, "Réaliser une étude hydraulique", "Si le projet soustrait plus de 400 m² à la zone d'expansion des crues d'un cours d'eau, il est soumis à déclaration Loi sur l’eau.", []),
        ("etude_2150", "action", "petitioner", 13, "Réaliser une étude de gestion des eaux pluviales", "Si le projet intercepte les eaux pluviales d'une surface de plus de 1 ha et les rejette dans le milieu naturel, il est soumis à déclaration Loi sur l’eau.", []),
        ("depot_etude_impact", "action", "petitioner", 2, "Déposer un dossier d'évaluation environnementale", "", []),
        ("depot_cas_par_cas", "action", "petitioner", 2, "Déposer une demande d’examen au cas par cas", "", []),
        ("depot_ein", "action", "petitioner", 3, "Réaliser une évaluation des incidences Natura 2000", "Cette évaluation des incidences (EIN) doit être jointe :\n<si auto_urba_needed>\n• à la demande de PA, PC ou de DP\n\n<si lse : soumis>\n• au dossier Loi sur l'eau\n\n<si lse : soumis_ou_pac>\n• si un dossier Loi sur l'eau est réalisé, à celui-ci\n\n<si aucun ci-dessus>\n• directement à la DDT(M)", []),
        ...
        ("pc_ein", "pc", "instructor", 2, "L’évaluation des incidences Natura 2000", "<si moulinette.natura2000.ein_out_of_n2000_site>\nCeci s’applique parce que le projet est soumis à la Loi sur l'eau ou à examen au cas par cas, et qu'il est donc soumis à évaluation des incidences Natura 2000 (EIN) bien qu'il se situe hors d’un site Natura 2000. L'EIN est une pièce obligatoire de la demande d'autorisation d'urbanisme – voir art. R414-19 I-2° et II du code de l’environnement", ["PC11-2", "PA15-1"]),
    ]
