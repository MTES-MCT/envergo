...
def test_users_instructor_or_invited(
    ...
    haie_user_no_department = UserFactory(
        is_active=True, access_amenagement=False, access_haie=True, is_instructor=True
    )
    ...
    # When a haie user is created with right to this department and `is_instructor` False
    instructor_haie_user_44_not_instructor = UserFactory(
        is_active=True, access_amenagement=False, access_haie=True, is_instructor=False
    )
    ...
    # When a haie user is created with right to this department and `is_instructor` True
