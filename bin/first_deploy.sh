...
PG_EXCLUDE="-N information_schema -N ^pg_* --exclude-table=spatial_ref_sys --exclude-table-data geodata_map --exclude-table-data geodata_zone --exclude-table-data evaluations_recipientstatus --exclude-table-data geodata_catchmentareatile --exclude-table-data tchap_tchapcredential "
